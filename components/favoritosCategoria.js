...
export default function FavoritosCategoria() {
  ...
  return (
    <>
      <p className="m-0 p-0 d-flex justify-content-between align-items-center w-100" onClick={fav} style={{cursor: 'pointer'}}>
